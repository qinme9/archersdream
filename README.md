...
这个模组只修改普通箭和光灵箭的方块碰撞形状查询，不影响：

- 玩家、生物、物品实体
- 雪球、火焰弹、三叉戟等其它投射物
- 方块破坏、放置、红石、活塞、掉落物
- 生物 AI、村民行为、世界生成
- 原版玩家/生物穿过门、栅栏、墙等方块时的碰撞行为

## 安装

1. 安装 NeoForge 1.21.1
2. 将 `archersdream-1.0.0.jar` 放入 `.minecraft/mods`
3. 启动游戏
...
```text
build/libs/archersdream-1.0.0.jar
```
...
- 只有当请求方是普通箭或光灵箭时，才会替换成更精细的箭矢专用碰撞形状
